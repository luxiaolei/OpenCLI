...
| **chatgpt** | `status` `new` `send` `read` `ask` `model` `deep-research` `deep-research-status` | 桌面端 / 浏览器 |
...
| **ChatGPT（浏览器）** | 面向 chatgpt.com 的浏览器 Deep Research 命令 | [Doc](./docs/adapters/browser/chatgpt.md) |
